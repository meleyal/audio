...
def get_device_parameters(ctx: Context, track_index: int, device_index: int) -> str:
    ...
    - device_index: The index of the device on the track (see get_track_info for device list)

    Returns the device name, class, and a list of parameters with their current value, min, max, and enabled/quantized status.
    """
    try:
        ableton = get_ableton_connection()
...
def set_device_parameter(
    ...
    - parameter_index: The index of the parameter to set (see get_device_parameters for parameter list)
    ...
    try:
        ...
        return f"Set '{result.get('parameter_name', '?')}' on '{result.get('device_name', '?')}' to {result.get('value', value)}"
    except Exception as e:
